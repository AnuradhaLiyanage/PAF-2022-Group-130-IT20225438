...
<article class="card-body mx-auto" style="width: 600px;">
    ...
    <div class="form-group input-group">
     ...
     <div class="form-group input-group">
        ...
        <input name="billno" class="form-control" id="billno" placeholder="Enter Bill Number" type="text">
    </div> 
    ...
    <div class="pfld" id="billinserterror">error</div>
    
    <input type="hidden" id="page" name="page" value="billinsertpage"/>
     <!-- form-group// -->                                     
    <div class="form-group">
        <button type="button" id="billingbtnSave" name="billingbtnSave" class="btn btn-primary btn-block">Submit Billing Details</button>
    </div> <!-- form-group// -->      
